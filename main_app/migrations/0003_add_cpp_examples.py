...
"""Populate the db with some cpp examples"""

from django.db import migrations


def add_cpp_examples(apps, schema_editor):
    """The main function with examples"""
    cpp_example_class = apps.get_model("main_app", "CppExample")
    ...
    examples = [
        ...
        },
        {
            ...
            "status": "undefined behavior",
            "explanation": "Writing beyond the bounds of a fixed-size array causes undefined "\
                           "behavior.",
        },
        {
            "code": 'int main() {\n    return "hello";\n}',
            "status": "does not compile",
            "explanation": "Returning a string literal from a function declared to return int "\
                           "is a compile error.",
        },
        {
            "code": "#include <iostream>\nint main() {\n    int x = 1;\n    int y = x++ + ++x;"\
        ...
        },
        {
            ...
            "explanation": "The program does not use std::cout, so nothing is printed,"\
                           " but return is valid.",
        },
    ]

    for ex in examples:
        cpp_example_class.objects.create(
